      ...
      <div className="card-column2">
        <div>
          ...
          <div className="method-container">
            <button className="btn-payon">
              Credit/Debit Card{" "}
              <img src="https://res.cloudinary.com/sliit-yasantha/image/upload/v1662391777/icons8-credit-card-30_zpetxw.png" />{" "}
            </button>{" "}
            <br />
            <button className="btn-payon">
              Bank Payment{" "}
          ...
          <div className="method-container2">
            <button className="btn-payoff">
              Cash On Delivery{" "}
              <img src="https://res.cloudinary.com/sliit-yasantha/image/upload/v1662391777/icons8-cash-30_mwwzdi.png" />
            </button>
          </div>
        </div>
      </div>
