...
export default function Header() {
    ...
    const userLink = () => {
      return <li className="drop-nav">
          ...
          <img src={user.avatar} alt=""/> <li><Link className='header-al'
  ...
  return (
    ...
    <div className="logo-head">
        <h1 className='logo-name'><Link to="/">&nbsp;&nbsp;
        Classy Services</Link></h1>
    ...
    <ul style={transForm}>
        {
            isLogged
            ? userLink()
            :<li><Link className='header-al' to="/register"><i className="fas fa-user"></i> Sign up</Link></li>
