...
var _GoogleAuth_instances, _GoogleAuth_getProjectIdOptional, _GoogleAuth_findAndCacheProjectId;
...
class GoogleAuth {
    ...
    async getProjectIdAsync() {
        ...
        if (!this._findProjectIdPromise) {
            this._findProjectIdPromise = __classPrivateFieldGet(this, _GoogleAuth_instances, "m", _GoogleAuth_findAndCacheProjectId).call(this);
        }
    ...
    async getApplicationDefaultAsync(options = {}) {
        ...
        if (this.cachedCredential) {
            return {
                ...
                projectId: await __classPrivateFieldGet(this, _GoogleAuth_instances, "m", _GoogleAuth_getProjectIdOptional).call(this),
            };
        }
        let credential;
        let projectId;
...
_GoogleAuth_instances = new WeakSet(), _GoogleAuth_getProjectIdOptional = 
/**
 ...
 */
async function _GoogleAuth_getProjectIdOptional() {
    try {
...
}, _GoogleAuth_findAndCacheProjectId = 
/*
 ...
 * @returns projectId
 */
async function _GoogleAuth_findAndCacheProjectId() {
    let projectId = null;
